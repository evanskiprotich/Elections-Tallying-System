...
class ElectionResult(models.Model):
    ...
    def __str__(self):
        return str(self.officer) + " " + str(self.candidate_one) + " " + str(self.candidate_two) + " " + str(self.candidate_three) + " " + str(self.candidate_four)

# get totalvotes of each candidate
